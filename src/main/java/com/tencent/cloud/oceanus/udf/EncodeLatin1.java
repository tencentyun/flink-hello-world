...
/**
 * 如果 JDBC 数据库的 VARCHAR 为 Latin1 (或 GBK 等) 编码 可以使用这个函数将 Java 字符串编码后写入
 *
 * <p>SQL 代码声明方式: CREATE TEMPORARY SYSTEM FUNCTION ENCODE_LATIN1 AS
 * 'com.tencent.cloud.oceanus.udf.EncodeLatin1' LANGUAGE JAVA;
 */
